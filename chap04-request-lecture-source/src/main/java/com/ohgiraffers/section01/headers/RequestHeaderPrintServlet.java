...
public class RequestHeaderPrintServlet extends HttpServlet {
    ...
    * 4. Entity header
    *       컨텐츠의 길이나 MIME 타입과 같은 엔티티 body에 대한 상세정보를 포함하는 헤더
    *       (요청 응답 모두 사용되며, 메시지 바디의 컨텐츠를 나타내기에 GET요청을 해당되지 않는다)
    *
    * */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("==============request header값 출력하기================");
        ...
        // HTTP 통신이 완료된 후에 네트워크 접속을 유지할지 결정(기본값 Keep-alive = 연결을 열린상태로 유지)
        ...
        // 출처(origin)와 요청된 resource 사이의 관계
