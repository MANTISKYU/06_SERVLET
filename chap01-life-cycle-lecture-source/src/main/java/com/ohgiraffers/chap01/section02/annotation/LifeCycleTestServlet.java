...
public class LifeCycleTestServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        System.out.println("annotation매핑 init() 메소드 호출" + initCount++);
    }
    ...
    // 서블릿 컨테이너가 종료될 때 호출되는 메소드, 주로 자원을 반납하는 용도료 사용된다.
    @Override
    public void destroy() {
        System.out.println("annotation매핑 destroy() 메소드 호출" + destroyCount++);
    }
